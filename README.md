...
Приложение-игра по распутыванию слов. Используется ViewModel, DataBinding, LiveData с наблюдателями для сохранения состояния при изменении конфигурации и автоматического обновления UI при изменении данных.
