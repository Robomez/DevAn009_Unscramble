...
Приложение-игра по распутыванию слов. Используется ViewBinding, DataBinding, LiveData с наблюдателями для сохранения состояния при изменении конфигурации и автоматического обновления UI при изменении данных.

<img src="Screenshot_20230609_002137.png" width=60%>
